        ...
        <div className="mb-10">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="hidden lg:flex items-center gap-6">
              ...
              <div className="text-center px-4 py-2 bg-blue-900/20 border border-blue-800 rounded-lg">
              ...
              <div className="text-center px-4 py-2 bg-green-900/20 border border-green-800 rounded-lg">
