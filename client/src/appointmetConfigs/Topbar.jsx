        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-5">
            ...
            <div className="relative group">
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-slate-300 to-slate-100 border border-slate-600 flex items-center justify-center text-slate-800 font-mono text-xl font-bold shadow-lg group-hover:scale-105 transition-transform duration-200">
                {initials}
              </div>
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-3">
                <h1 className="text-2xl font-mono font-bold bg-gradient-to-r from-white via-slate-100 to-slate-300 bg-clip-text text-transparent">
