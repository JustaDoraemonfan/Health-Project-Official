...
import { formatDate, getStatusClass } from "../../utils/appointmentUtils";
...
const AppointmentDetails = ({ appointment }) => {
  ...
  return (
    <>
      ...
      {/* Main Details Grid - Already Responsive */}
      ...
      <div className="mt-8">
        <div className="flex items-center gap-3 mb-4">
          <h3 className="text-white font-semibold text-lg">Reason for Visit</h3>
...
export const AppointmentSidebar = ({ appointment, userName }) => {
  if (!appointment) return null;
      ...
      <div className="border-t border-slate-700 pt-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col items-start sm:flex-row sm:justify-between sm:items-start gap-1">
            ...
            <span className="text-white text-sm text-left sm:text-right break-all">
      ...
      <div className="border-t border-slate-700 pt-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col items-start sm:flex-row sm:justify-between sm:items-start gap-1">
            ...
            <span className="text-white text-sm text-left sm:text-right break-words">
