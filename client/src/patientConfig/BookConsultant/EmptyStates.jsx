...
const EmptyState = ({ location, onReset }) => {
  return (
    <div className="text-center py-16">
      <div className="w-20 h-20 bg-transparent rounded-lg flex items-center justify-center mx-auto mb-6">
        <Search className="w-10 h-10 text-gray-500" />
      </div>
      <h3 className="text-2xl font-medium text-black mb-3">No doctors found</h3>
