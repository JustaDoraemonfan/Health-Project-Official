...
const ConsultationNoteCard = ({ note }) => {
  ...
  return (
    <div className="bg-[var(--color-secondary)] rounded-xl shadow-sm border spline-sans-mono-400 border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
