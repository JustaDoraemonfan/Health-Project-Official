...
const SectionCard = ({ section, onClick, count }) => {
  ...
  return (
    <div
      ...
      className="bg-[var(--color-secondary)] rounded-2xl shadow-lg border spline-sans-mono-400 border-gray-100 p-6 md:p-8 cursor-pointer transform hover:scale-105 hover:shadow-xl transition-all duration-300 group"
    >
